        ...
        <nav className='navbar navbar-expand-lg navbar-devto'>
          <div className='container p-md-0'>
            ...
            <div className='d-flex items-center h-100 ml-auto'>
              ...
              <button
                className='btn btn-outline-primary m-auto d-none'
                id='btn-post'
              >
                {' '}
                <a href='./new.html'> Create Post</a>
              </button>
              <button
                className='btn bg-transparent btn-sm position-relative d-none'
                id='btn-notif'
              >
                <img
              ...
              <a
                ...
                className='btn btn-sm p-1 wrapper-avatar c-btn d-none'
                id='btn-avatar'
              >
