...
// const HomePosts = dynamic(() => import('../components/HomePost'), {
//   suspense: true,
// })
              ...
              {/* <aside className="asideleft d-none d-md-block col-md-3">
                <ul className="navbar-nav mb- mx-0">
                  ...
                  <li className="nav-item">
                    <a className="nav-link" href="#">
                      <span>
                        <img
                          src="./assets/icons/icon-podcasts.svg"
                          alt="Icon"
                        />
                      </span>
                      Podcasts
                  ...
                  <li className="nav-item">
                    <a className="nav-link" href="#">
                      <span>
                        <img
                          src="./assets/icons/icon-sponsors.svg"
                          alt="Icon"
                        />
                      </span>
                      Sponsors
                ...
                <div className=" card p-3 mt-4">
                  <img
                    ...
                    alt=""
                  />
                  <h3 className=" mt-4 article__title ">
